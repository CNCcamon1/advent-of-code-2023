...
fun get_win_permutations(l: Long, m: Long): Int{
...
fun main() {
  ...
  val gameLength = gameLengths.joinToString("").toLong()
  val gameDistance = gameDistances.joinToString("").toLong()

  var winPermutations: Int = 1
  winPermutations *= get_win_permutations(gameLength, gameDistance)
